...
In addition, Friday afternoon is dedicated to pair programming session. This \emph{mandatory} event is meant to share knowledge about internal projects and to fix Pharo bugs. % DC: pharo related
